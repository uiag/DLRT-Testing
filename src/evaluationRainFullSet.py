...
FOLDER_NAMES = ["DLRT(Rank4)TestDim1-500ep250batch256lr1e-3Noise20", "DLRT(Rank6)TestDim1-500ep250batch256lr1e-3Noise20", "DLRT(Rank10)TestDim1-500ep250batch256lr1e-3Noise20", "DLRT(Rank20)TestDim1-500ep250batch256lr1e-3Noise20", "DLRT(Rank50)TestDim1-500ep250batch256lr1e-3Noise20", "DLRT(Rank100)TestDim1-500ep250batch256lr1e-3Noise20"]
FOLDER_NAME_FR = "TestDim1-500ep250batch256lr1e-3Noise20"
FOLDER_NAMES_EXTRA = ["TestDim600ep250batch256lr1e-3Noise20", "TestDim700ep250batch256lr1e-3Noise20", "TestDim800ep250batch256lr1e-3Noise20",
                      "TestDim900ep250batch256lr1e-3Noise20", "TestDim1000ep250batch256lr1e-3Noise20", "TestDim1500ep250batch256lr1e-3Noise20", 
                      "TestDim2000ep250batch256lr1e-3Noise20", "TestDim2500ep250batch256lr1e-3Noise20", "TestDim3000ep250batch256lr1e-3Noise20",
                      "TestDim3500ep250batch256lr1e-3Noise20", "TestDim4000ep250batch256lr1e-3Noise20", "TestDim4500ep250batch256lr1e-3Noise20",
                      "TestDim5000ep250batch256lr1e-3Noise20"]
FOLDER_NAME_REG = "TestDim1-500ep250batch256lr1e-3Noise20Reg1"
...
for count, el in enumerate(FOLDER_NAMES):
    ...
    lengFiles = 0
    epochs = 0
    linkToRun = "finishedTestsFullSet\\" + el
...
lengFiles = 0
epochs = 0
linkToRun = "finishedTestsFullSet\\" + FOLDER_NAME_FR
...
for count, el in enumerate(FOLDER_NAMES_EXTRA):
    ...
    lengFiles = 1
    epochs = 0
    linkToRun = "finishedTestsFullSet\weitereDim\\" + el
    size = (count+6)*100
    if count > 4:
...
lengFiles = 0
epochs = 0
linkToRun = "finishedTestsFullSet\\" + FOLDER_NAME_REG
